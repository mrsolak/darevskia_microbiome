...
dir.create("results/D1_all/plots/14_beta_diversity", recursive = TRUE, showWarnings = FALSE)
dir.create("results/D1_all/tables/14_beta_diversity", recursive = TRUE, showWarnings = FALSE)
...
dist_list <- list(
  "Bray-Curtis"        = phyloseq::distance(PS_merged_sanger, method = "bray"),
  "Jaccard"            = phyloseq::distance(PS_merged_sanger, method = "jaccard", binary = TRUE),
  "Weighted UniFrac"   = phyloseq::distance(PS_merged_sanger, method = "wunifrac"),
  "Unweighted UniFrac" = phyloseq::distance(PS_merged_sanger, method = "unifrac")
)
dist_names <- names(dist_list)

# ============================================================
# Step 2: PERMANOVA — within-individual strata
# Permutations restricted within individuals to account for
# paired samples (same individual contributing both intestine types)
# ============================================================
...
# ============================================================
# Step 3: PERMDISP — homogeneity of multivariate dispersions
# ============================================================
...
ggsave("results/D1_all/plots/14_beta_diversity/PCoA_combined.png",
...
print(doc, target = "results/D1_all/tables/14_beta_diversity/beta_diversity_stats.docx")

cat("\nAll beta diversity outputs saved to:\n")
cat("  results/D1_all/plots/14_beta_diversity/\n")
cat("  results/D1_all/tables/14_beta_diversity/\n")
